...
// These four videos are hosted on Cloudflare R2 instead of bundled locally —
// they were too large for GitHub/Cloudflare Workers (over 25MB each).
const R2_BASE = "https://pub-86af84d8c4a34cf991aa0e00cac3ba67.r2.dev";
const fashionLaunchVideo = `${R2_BASE}/fashion-brand-launch.mp4`;
const traditionalWeddingVideo = `${R2_BASE}/traditional-wedding.mp4`;
const tusVideo = `${R2_BASE}/tus-ireland.mp4`;
const showreelVideo = `${R2_BASE}/luxury-watches.mp4`;
...
export const SERVICES = [
  {
    ...
    image: "https://images.unsplash.com/photo-1778876088394-554203c86d65?w=1200&q=80",
  },
  {
    n: "02",
    ...
    image: "https://images.unsplash.com/photo-1739285452618-0b7b3d04f953?w=1200&q=80",
  },
  {
    n: "03",
    ...
    image: "https://images.unsplash.com/photo-1770777352860-509edd406ac5?w=1200&q=80",
  },
  {
    n: "04",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1767661667474-4f2a197c9a51?w=1200&q=80",
  },
  {
    n: "07",
...
export const PORTFOLIO: { title: string; category: Category; image: string }[] = [
  ...
  { title: "Heritage Jewelry Macro", category: "Product Videos", image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=1200&q=80" },
